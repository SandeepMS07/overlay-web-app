...
/** Screen with a slash: the overlay is kept out of screen captures. */
export const NoCaptureIcon = wrap(
  <path d="M3 4h18v12H3zm2 2v8h14V6zM2.8 2.4 21.6 21.2l-1.4 1.4L1.4 3.8zM8 19h8v2H8z" />
);
/** Plain screen: the overlay is captured like any other window. */
export const CaptureIcon = wrap(<path d="M3 4h18v12H3zm2 2v8h14V6zM8 19h8v2H8z" />);
